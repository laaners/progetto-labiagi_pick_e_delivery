...
(cl:defmethod cl:initialize-instance :after ((m <Pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pick_e_delivery-msg:<Pose> is deprecated: use pick_e_delivery-msg:Pose instead.")))
...
(cl:defmethod yaw-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pick_e_delivery-msg:yaw-val is deprecated.  Use pick_e_delivery-msg:yaw instead.")
  (yaw m))
