...
class LocalPathPlannerStatus {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LocalPathPlannerStatus(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new LocalPathPlannerStatus(null);
...
module.exports = LocalPathPlannerStatus;
