...
namespace srrg2_slam_interfaces {
  ...
  template <typename VariableType_>
  void
  AlignerSliceProcessorBase_<VariableType_>
  ::reset() {
    _fixed_scene = nullptr;
    _moving_scene = nullptr;
    _robustifier_changed_flag  = true; 
    _fixed_slice_changed_flag  = true; 
    _moving_slice_changed_flag = true; 
    _dummy_corr.clear();
  }
