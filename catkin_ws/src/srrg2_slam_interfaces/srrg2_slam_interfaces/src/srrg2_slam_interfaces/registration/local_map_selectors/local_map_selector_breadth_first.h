...
namespace srrg2_slam_interfaces {
   ...
   * Graph-base search both via connection and metric distance
   */
  ...
  public:
    ...
    using ThisType              = LocalMapSelectorBreadthFirst_<SLAMAlgorithmType>;
  ...
  protected:
    srrg2_solver::FactorGraphVisit
      _visit; /**< visit algorithm for the graph, TODO possibly use it as property in future*/
  };
} // namespace srrg2_slam_interfaces
