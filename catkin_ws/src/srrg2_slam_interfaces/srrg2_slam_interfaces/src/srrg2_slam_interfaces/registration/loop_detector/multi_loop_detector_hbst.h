...
namespace srrg2_slam_interfaces {
  ...
  public:
    ...
    using BaseType          = MultiLoopDetectorBruteForce_<SLAMAlgorithmType_, AlignerType_>;
  ...
  public:
    void reset()  override{
      ...
      _database.clear();
      _graph_id_to_database_index.clear();
      _local_maps_in_database.clear();
      _indices.clear();
      _correspondences_per_reference.clear();
      _fixed_current_local_map = nullptr;
      _moving_past_local_map = nullptr;
    }
  };
