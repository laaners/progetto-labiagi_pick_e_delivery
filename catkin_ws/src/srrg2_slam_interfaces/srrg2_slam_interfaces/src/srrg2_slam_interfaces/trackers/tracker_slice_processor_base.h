...
namespace srrg2_slam_interfaces {
  ...
  protected:
     ...
     */
    virtual void setRawData(srrg2_core::BaseSensorMessagePtr msg_,
                            TrackerReportRecord& report_record_) = 0;
    ...
    void reset() override {
      _sensor_in_robot = EstimateType::Identity();
      _robot_in_sensor = EstimateType::Identity();
      _robot_in_local_map = EstimateType::Identity();
      _robot_in_world = EstimateType::Identity();
      _world_in_robot = EstimateType::Identity();
      _measurements_container = nullptr; 
      _clipped_scene_container = nullptr; 
    }
  };
  ...
  protected:
    ...
    void adapt() override;
    void setRawData(srrg2_core::BaseSensorMessagePtr msg_,
