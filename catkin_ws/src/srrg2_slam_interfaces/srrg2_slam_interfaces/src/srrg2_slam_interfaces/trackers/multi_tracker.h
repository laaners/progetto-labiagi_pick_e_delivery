...
namespace srrg2_slam_interfaces {
  ...
  protected:
    ...
    srrg2_core::PropertyContainerDynamic _dummy_scene;   /**scene used as default when running in standalone mode*/
    srrg2_core::PropertyContainerBase* _scene=&_dummy_scene;   /**temp ptr to the current scene*/
