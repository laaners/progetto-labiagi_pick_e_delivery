...
namespace srrg2_slam_interfaces {
  ...
  class MultiGraphSLAM_ : public srrg2_core::MessageSinkBase,
  ...
  public:
    ...
    using BaseType               = srrg2_core::MessageSinkBase;
    using FactorMessageType      = FactorMessage_<FactorBaseType>;
    using FactorMessageTypePtr   = std::shared_ptr<FactorMessageType>;
    using LocalMapMessageType    = LocalMapMessage_<LocalMapType>;
    using LocalMapMessageTypePtr = std::shared_ptr<LocalMapMessageType>;
    using NodeUpdateMessageType  = NodeUpdateMessage_<LocalMapType>;
    using NodeUpdateMessageTypePtr  = std::shared_ptr<NodeUpdateMessageType>;
  ...
  protected:
    ...
    std::list<BaseSensorMessagePtr> _slam_update_messages;
    LocalMapMessageTypePtr _current_local_map_msg = nullptr;
  };
