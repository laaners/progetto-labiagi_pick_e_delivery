...
namespace srrg2_core_ros {
  ...
  public:
    ...
    static srrg2_core::BaseSensorMessagePtr convert(turtlesim::PoseConstPtr message_in_);
    static srrg2_core::BaseSensorMessagePtr convert(grid_map_msgs::GridMapConstPtr message_in_);
    static srrg2_core::BaseSensorMessagePtr convert(srrg2_core_ros::PlannerStatusMessageConstPtr message_in_);
    // ds SRRG to ROS
  public:
    ...
    static srrg2_core_ros::PlannerStatusMessagePtr convert(srrg2_core::PlannerStatusMessagePtr message_in_);
  ...
  public:
    ...
    template <typename SRRGMessageType_>
    static std::shared_ptr<SRRGMessageType_> convert(turtlesim::PoseConstPtr message_in_) {
      return std::dynamic_pointer_cast<SRRGMessageType_>(convert(message_in_));
    }
