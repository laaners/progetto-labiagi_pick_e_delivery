...
namespace srrg2_solver {
  ...
  public:
    ...
    enum SolverEvent  : int { ComputeStart = 0,
                              ComputeEnd=1,
                              IterationStart=2,
                              IterationEnd=3,
                              LevelStart=4,
    ...
    */
    ...
    bool lambdaRatio(float& lambda_min, float& lambda_max,
                     VariableBase* v, int level=0);

    inline void suppressPerturbation() {_suppress_perturbation=true;}
    ...
    bool levelChanged() const {return _level_changed;}
  ...
  protected:
    ...
    std::set<VariableBase::Id> _active_variables_set; /*!< Container of variables that partecipate to
                                                     the optimizaion in the current level*/
LevelFactorPtrVectorMap _active_factors; /*!< Container of factors that partecipate to the optimizaion in each level*/
