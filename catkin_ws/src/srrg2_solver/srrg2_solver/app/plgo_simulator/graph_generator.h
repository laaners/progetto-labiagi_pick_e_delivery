...
namespace srrg2_solver {
  ...
  protected:
    virtual VariableBase* createLandmarkSensorOffsetVariable() = 0;
  ...
  struct GraphGeneratorSE3BA : public GraphGeneratorSE3 {
    GraphGeneratorSE3BA(PLGOSimulator& sim_): GraphGeneratorSE3(sim_){}
    FactorBase*   createLandmarkFactor(int idx_from, int idx_to, int idx_offset) override ;
  };
